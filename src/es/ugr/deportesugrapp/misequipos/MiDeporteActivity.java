...
public class MiDeporteActivity extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		SolicitudInfoDeportesTask task = new SolicitudInfoDeportesTask(Global.baseURLServidorNice);
	...
	void crearBoton(Deporte deporte){
		...
		boton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Intent intent=new Intent(MiDeporteActivity.this,EleccionEquipoActivity.class);
