...
public class MiTorneoActivity extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		SolicitudInfoTorneosTask task = new SolicitudInfoTorneosTask(Global.baseURLServidorNice);
		
		// Averiguamos el año, y solicitamos sólo los torneos definidos para ese año
	...
	void crearBoton(DatosCategoria categoria){
		...
		boton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				Intent intent=new Intent(MiTorneoActivity.this,MiDeporteActivity.class);
