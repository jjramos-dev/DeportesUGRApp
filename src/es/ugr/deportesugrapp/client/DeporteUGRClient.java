...
public class DeporteUGRClient {
	...
	public List<PistaReservable> obtenerListaPistasReservables() {
      ...
      try {
          ...
          Logger.getLogger(DeporteUGRClient.class.getName()).log(Level.SEVERE, null, ex);
      }
      
      return listaPistasReservables;
  }
	
    public String obtenerTablaReservasFecha(String codigo, String titulo, String fecha) {
    ...
    public String obtenerTablaReservasFecha(String codigo, String dia, String mes, String anio) {
        String tablaHTML=null;
     try {
    
         
         String respuesta = "";
         String url = baseURL + "/reservas/pistas/"+codigo+"/fecha/"+dia+"-"+mes+"-"+anio+"";
	...
	public List<Equipo> obtenerEquipo(String trofeoId, String deporteId) {
      ...
      try {
          // Miramos los equipos:
          listaEquipos= mapper.readValue(respuesta, new TypeReference<List<Equipo>>() {});
