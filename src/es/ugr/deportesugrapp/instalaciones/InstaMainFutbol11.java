...
public class InstaMainFutbol11 extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		actionBar.setSubtitle("Pista Fútbol 11");
		
		
		// Las funciones de red hay que lanzarlas en backgronud:
		int progreso=0;
		
		new SolicitudInfoPistaTask().execute(3);
...
public class SolicitudInfoPistaTask extends AsyncTask<Integer, Integer, PistaFutbol11>{
...
protected PistaFutbol11 doInBackground(Integer... params) {
    ...
    pista=mapper.readValue(respuesta, PistaFutbol11.class);
...
@Override
		protected void onPostExecute(PistaFutbol11 pista2) {
			...
			if(pista!=null){
				...
				//nombrePista.setText("Pista Futbol 11");
