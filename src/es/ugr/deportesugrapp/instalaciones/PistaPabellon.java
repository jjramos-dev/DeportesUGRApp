...
/**
 * Clase que contiene la informacion de los pabellones
 *
 */
public class PistaPabellon {
	...
	/**
	 *Metodo que permite asignar una ID a la pista
	 * @param id
	 */
	 ...
	 */
	public PistaPabellon(String pistaId, String nom, String preUniSinLuz,
