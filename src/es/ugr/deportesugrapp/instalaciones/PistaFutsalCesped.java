...
public class PistaFutsalCesped {
    String pistaId=null;
    //int numero=13;
    String nombre = "Futsal cesped";
//    String descripcion;
    String precioUniSinLuz="18 €";
    String precioUniLuz="24 €";
    String precioNoUniSinLuz="30 €";
    String precioNoUniLuz="40 €";
    String precioPeniaUniSinLuz="650 €";
    String precioPeniaUniLuz="750 €";
    ...
    public PistaFutsalCesped(String pistaId, String nom, String preUniSinLuz, String preUniLuz, String preNoUniSinLuz, String preNoUniLuz, String prePeniaUniSinLuz, String prePeniaUniLuz, String prePeniaNoUniSinLuz, String prePeniaNoUniLuz) {
